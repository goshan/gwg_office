    ...
    if (current_status == "gaming"){
      if (current_player_id == current_player_turn){
        ...
        if (can_attack){  // after search attack scope, waiting for selecting attack object
          ...
          var selected_player = $(".wait_for_move").children(".hero").attr("player");
          var clicked_player = $(this).attr("player");
          var selected_hero = $(".wait_for_move").children(".hero").attr("hero")
          var clicked_hero = $(this).attr("hero");
          if (selected_player == clicked_player && selected_hero == clicked_hero){ // clicking hero is selected hero
